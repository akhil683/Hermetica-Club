  ...
  return (
    <div>
      <div className='mb-6'>
        ...
        <p className=' text-iconbgHover text-sm sm:max-w-[350px]'>"We React to What Matters !" Team Hermetica, was established as the departmental team of Chemical Engineering, at the National Institute of Technology, Hamirpur in the year 2014.</p>
      </div>
