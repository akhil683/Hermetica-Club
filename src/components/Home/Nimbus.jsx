  ...
  return (
    <section className='min-h-screen mt-6 max-sm:mb-16 max-sm:mx-12 flex flex-wrap justify-center items-center gap-6'>
      ...
      <div className='text-center p-6 px-12 flex flex-col items-center justify-center w-full sm:w-[350px] bg-footerBg hover:scale-105 shadow-violet duration-200 shadow-inner'>
        ...
        <p className='text-sm sm:h-[220px] text-subMainText'>
          To conceive new knowledge via innovative research and collaborative initiatives that provide opportunity for long-term interaction wiht academia and industry. <br /> <br /> To train high-quality people an intellectual resources to serve society. To create environmentally friendly goods and technologies. The mission of Team Hermetica is to be the best.
        </p>
      </div>
      </FramerReveal>
