    ...
    <FramerReveal>
        ...
        >
          ...
          <div className='sm:w-[300px] w-full sm:h-[350px] bg-violet rounded-2xl overflow-hidden'>
            <img className='w-full sm:h-full object-cover' src={NikhilImg} alt="Nikhil Sir" />
          </div>
        </div>
      </FramerReveal>
      <motion.div 
      ...
      >
        ...
        <div className='my-6'>
          <a className='px-4 py-2 bg-mainText text-mainBg rounded-full' href="https://www.instagram.com/jnikhil979/?igshid=Mzc0YWU1OWY%3D" target='_blank'>Instagram</a>
          <a className='px-4 py-2 bg-mainText text-mainBg rounded-full ml-4' href="https://www.linkedin.com/in/nikhil-singh-jadon-733845251/" target='_blank'>LinkedIn</a>
        </div>
      </motion.div>
    </>
  )
