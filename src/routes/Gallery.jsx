...
const Gallery = () => {
  ...
  const defaultGallery = data.filter((data) => data.Event == "Pre-Nimbus");
    ...
    <div className="sm:mb-12 pb-16">
      ...
      >
        <button
          ...
          onClick={() => filterHandler("Pre-Nimbus")}
        >
          Pre-Nimbus
        </button>
        <button
          className="py-2 px-4 bg-iconbgHover rounded-full hover:bg-violet focus:bg-violet duration-200"
          onClick={() => filterHandler("Hday")}
        >
          Hermetica Day
        </button>
        <button
        ...
        <button
          className="py-2 px-4 bg-iconbgHover rounded-full hover:bg-violet focus:bg-violet duration-200"
          onClick={() => filterHandler("Awareness")}
        >
          Awareness
        </button>
        <button
          className="py-2 px-4 bg-iconbgHover rounded-full hover:bg-violet focus:bg-violet duration-200"
          onClick={() => filterHandler("Nimbus")}
        >
          Nimbus 2k23
        </button>
      </div>
              ...
              <FramerReveal key={image.ImageLink}>
                <div className="relative w-[400px] sm:w-[330px] min-h-[200px] sm:h-[260px] border border-iconbgHover overflow-hidden group">
                  <a
                    ...
                    className="absolute px-4 py-2 bg-mainText text-mainBg rounded-full bottom-2 right-4 translate-y-16 opacity-0 group-hover:opacity-90 font-semibold group-hover:translate-y-0 duration-300"
                    target="_blank"
                  >
                    Download
                  </a>
